...
<body>
    <div class="paper">
        ...
        <header>
            ${assessment.patient.logoUrl ? `<img src="${assessment.patient.logoUrl}" class="header-logo" alt="Logo Profissional">` : `<div class="logo-box">YSQ SMART AI</div>`}
        ...
        ${assessment.aiAnalysis ? `
          <div class="section" style="page-break-before: always;">
              <div class="section-header">Análise Clínica Qualitativa (IA)</div>
