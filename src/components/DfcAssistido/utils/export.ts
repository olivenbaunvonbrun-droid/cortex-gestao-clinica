...
export async function exportToHtml(record: DfcRecord) {
...
<body>
    <div class="paper">
        ...
        <header>
            ${logoUrl ? `<img src="${logoUrl}" class="header-logo" alt="Logo Profissional">` : `<div class="logo-box">DFC ASSISTIDO</div>`}
