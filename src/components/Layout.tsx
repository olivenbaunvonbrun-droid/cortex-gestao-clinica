...
import { User, LogOut, Users, Calendar, MessageSquare, DollarSign, BarChart3, Palette, Bell, HelpCircle, History, AlertTriangle, AlertCircle, Info, Check, X, CheckSquare, Cloud, CloudOff, RefreshCw, Brain, Sparkles } from 'lucide-react';
