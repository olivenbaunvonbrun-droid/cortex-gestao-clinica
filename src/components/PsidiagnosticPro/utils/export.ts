...
export function exportToHtml(record: DiagnosticRecord) {
...
<body>
    <div class="paper">
        ...
        <header>
            ${record.patient.logoUrl ? `<img src="${record.patient.logoUrl}" class="header-logo" alt="Logo Profissional">` : `<div class="logo-box">PSIDIAGNOSTIC PRO</div>`}
