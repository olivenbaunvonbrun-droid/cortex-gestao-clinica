...
export default function HistoryPanel({
  ...
  const handleDownloadReportHtml = async (report: Report) => {
      ...
      <body>
        ...
        <div class="header-box">
          ...
          <div class="meta-grid">
            ...
            <div><strong>Instrumento:</strong> ${report.toolTitle}</div>
        ...
        <div class="score-badge">Classificação Clínico-Psicométrica: ${report.calculatedScores.classification} | Score Total: ${report.calculatedScores.score}</div>
